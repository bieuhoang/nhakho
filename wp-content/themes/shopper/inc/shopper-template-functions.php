...
if ( ! function_exists( 'shopper_credit' ) ) {
	...
	function shopper_credit() {
		?>
		<div class="site-info">			
			Bản quyền trang web và những bài đăng trong website này thuộc quyền sở hữu hợp pháp của Nhà kho. Đã đăng ký và được Pháp luật Việt Nam bảo hộ. Quý vị copy, trích dẫn, chia sẻ vui lòng ghi rõ nguồn. Trân trọng cảm ơn. Thiết kế Website thực hiện bởi đội ngũ Nhà kho
